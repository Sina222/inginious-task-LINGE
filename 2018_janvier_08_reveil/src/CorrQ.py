class Reveil:
    ...
    def Reveil(self,heure, minute, seconde):
        self.__heure=heure
        self.__minute=minute
        self.__seconde=seconde
    ...
    def __str__(self):
        return "Heure: {} Minute: {} Seconde: {}".format(self.getHeure(),self.getMinute(),self.getSeconde())

"""
reveil = Reveil(23,22,33)
print(reveil)
reveil.NouvelleHeure(845)
print(reveil)
"""
